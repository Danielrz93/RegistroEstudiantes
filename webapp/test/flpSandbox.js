		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Inscripción Pregrado",
									"targetURL": "#npregistroestudiantes-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"npregistroestudiantes-display": {
								"semanticObject": "npregistroestudiantes",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=np.registroestudiantes",
									"url": sap.ui.require.toUrl("np/registroestudiantes")
								}
							}
						}
					}
